...
TEST(SPDYCodecTest, SPDYVersionSettingsCommonHeaderNameCheck) {
  ...
  EXPECT_EQ(HTTPCommonHeaders::hash(spdy::kNameStatusv3),
            HTTP_HEADER_COLON_STATUS);
  EXPECT_EQ(HTTPCommonHeaders::hash(spdy::kNameMethodv3),
            HTTP_HEADER_COLON_METHOD);
  EXPECT_EQ(HTTPCommonHeaders::hash(spdy::kNameSchemev3),
            HTTP_HEADER_COLON_SCHEME);
  EXPECT_EQ(HTTPCommonHeaders::hash(spdy::kNamePathv3), HTTP_HEADER_COLON_PATH);
}
 ...
 */
uint8_t synStream[] = {
    ,
};
...
TEST(SPDYCodecTest, SetSettings) {
  ...
  EXPECT_EQ(settings->getSetting(SettingsId::INITIAL_WINDOW_SIZE)->value,
            spdy::kInitialWindow);
  EXPECT_EQ(settings->getSetting(SettingsId::_SPDY_DOWNLOAD_BANDWIDTH)->value,
            10);
  ...
  EXPECT_EQ(settings->getSetting(SettingsId::MAX_CONCURRENT_STREAMS), nullptr);
  EXPECT_EQ(settings->getSetting(SettingsId::INITIAL_WINDOW_SIZE)->value, 123);
...
TEST(SPDYCodecTest, FrameTooLarge) {
  ...
  FakeHTTPCodecCallback callbacks;
  size_t unconsumed =
      parseSPDY(&codec, synStream, sizeof(synStream), -1, callbacks);
  EXPECT_EQ(unconsumed, 0);
  EXPECT_EQ(callbacks.sessionErrors, 1);
...
uint8_t spdy3UnknownCtlFrame[] = {
    ...
    0x03,
    0x00,
    0x0B, // ctl frame for spdy/3 (11 is not defined)
    0x00,
    0x00,
    0x00,
    0x02, // len = 2
...
TEST(SPDYCodecTest, UnsupportedFrameType) {
  SPDYCodec codec(TransportDirection::DOWNSTREAM, SPDYVersion::SPDY3);
  FakeHTTPCodecCallback callbacks;
  size_t unconsumed = parseSPDY(&codec,
                                spdy3UnknownCtlFrame,
                                sizeof(spdy3UnknownCtlFrame),
                                -1,
                                callbacks);
  EXPECT_EQ(unconsumed, 0);
  EXPECT_EQ(callbacks.sessionErrors, 0);
...
unique_ptr<folly::IOBuf> getSynStream(
  ...
  if (assocStreamId == SPDYCodec::NoStream) {
    ...
    egressCodec.generatePushPromise(
        output, streamID, msg, assocStreamId, eom, size);
  }
  return output.move();
}
...
#define copyForMe(F, C, V) callFunction<C>(F<C, C>, SPDYVersion::V)
...
void doEmptyHeaderValueTest(Codec1& ingressCodec, Codec2& egressCodec) {
  ...
  for (auto i = 0; i < 3; i++) {
    auto toParse =
        getSynStream(egressCodec, id + 2 * i, toSend, 0, false, &size);
    ingressCodec.onIngress(*toParse);
...
TEST(SPDYCodecTest, SynStreamWrongVersion) {
  ...
  size_t unconsumed =
      parseSPDY(&codec, frame->data(), frame->length(), -1, callbacks);
  EXPECT_EQ(unconsumed, 0);
...
void doShortSynReplyTest(Codec1& /*ingressCodec*/, Codec2& egressCodec) {
  ...
  auto frame = getVersionedSpdyFrame(
      shortSynReply, sizeof(shortSynReply), egressCodec.getVersion());
...
TEST(SPDYCodecTest, SupportsSessionFlowControl) {
  SPDYCodec spdy3(TransportDirection::UPSTREAM, SPDYVersion::SPDY3);
  SPDYCodec spdy3_1(TransportDirection::UPSTREAM, SPDYVersion::SPDY3_1);
...
TEST(SPDYCodecTest, HeaderWithManyValues) {
  ...
  FakeHTTPCodecCallback callbacks;
  SPDYCodec egressCodec(TransportDirection::UPSTREAM, SPDYVersion::SPDY3);
...
TEST(SPDYCodecTest, MultiplePaths) {
  ...
  auto frame = getVersionedSpdyFrame(multiple_path_headers,
                                     sizeof(multiple_path_headers),
                                     ingressCodec.getVersion());
  ingressCodec.setCallback(&callbacks);
...
TEST(SPDYCodecTest, ServerPush) {
  ...
  SPDYCodec ingressCodec(TransportDirection::UPSTREAM, SPDYVersion::SPDY3);
  ingressCodec.setCallback(&callbacks);
...
uint8_t pushStreamWithHostMissing[] = {
    0x80, 0x3,  0x0,  0x1,  0x2,  0x0,  0x0,  0x7c, 0x0,  0x0,  0x0,  0x2,
    0x0,  0x0,  0x0,  0x1,  0x0,  0x0,  0x38, 0x30, 0xe3, 0xc6, 0xa7, 0xc2,
    0x0,  0x62, 0x0,  0x9d, 0xff, 0x0,  0x0,  0x0,  0x4,  0x0,  0x0,  0x0,
    0x5,  0x3a, 0x70, 0x61, 0x74, 0x68, 0x0,  0x0,  0x0,  0x14, 0x68, 0x74,
    0x74, 0x70, 0x73, 0x3a, 0x2f, 0x2f, 0x77, 0x77, 0x77, 0x2e, 0x66, 0x6f,
    0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x0,  0x0,  0x0,  0x7,  0x3a, 0x73,
    0x63, 0x68, 0x65, 0x6d, 0x65, 0x0,  0x0,  0x0,  0x4,  0x68, 0x74, 0x74,
    0x70, 0x0,  0x0,  0x0,  0x7,  0x3a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
    0x0,  0x0,  0x0,  0x3,  0x32, 0x30, 0x30, 0x0,  0x0,  0x0,  0x8,  0x3a,
    0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x0,  0x0,  0x0,  0x8,  0x48,
    0x54, 0x54, 0x50, 0x2f, 0x31, 0x2e, 0x31, 0x0,  0x0,  0x0,  0xff, 0xff};
...
uint8_t pushStreamWithOddId[] = {
    };
...
uint8_t pushStreamWithoutUnidirectional[] = {
    0x80, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x91, 0x00, 0x00, 0x00, 0x02,
    0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x38, 0x30, 0xe3, 0xc6, 0xa7, 0xc2,
    0x00, 0x77, 0x00, 0x88, 0xff, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,
    0x05, 0x3a, 0x68, 0x6f, 0x73, 0x74, 0x00, 0x00, 0x00, 0x0b, 0x77, 0x77,
    0x77, 0x2e, 0x66, 0x6f, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x00,
...
uint8_t pushStreamWithoutAssoc[] = {
    0x80, 0x03, 0x00, 0x01, 0x02, 0x00, 0x00, 0x91, 0x00, 0x00, 0x00, 0x02,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x38, 0x30, 0xe3, 0xc6, 0xa7, 0xc2,
    0x00, 0x77, 0x00, 0x88, 0xff, 0x00, 0x00, 0x00, 0x05, 0x00, 0x00, 0x00,
    0x05, 0x3a, 0x68, 0x6f, 0x73, 0x74, 0x00, 0x00, 0x00, 0x0b, 0x77, 0x77,
    0x77, 0x2e, 0x66, 0x6f, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x00,
    0x07, 0x3a, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x00, 0x00, 0x00, 0x00,
...
uint8_t multiValuedHeaderAttack[] = {
    };
...
uint8_t invalidHeaderPlusEmptyBlock[] = {
    0x80, 0x03, 0x00, 0x02, 0xc4, 0x00, 0x00, 0x14, 0xf7, 0x76,
    0x2d, 0x37, 0x78, 0x9c, 0x93, 0x60, 0x00, 0x03, 0x75, 0x06,
    0xbd, 0x76, 0x21, 0xb2, 0xd0, 0xd9, 0x54, 0x91, 0x80, 0x03,
    0x00, 0x01, 0x4e, 0x00, 0x00, 0x0a, 0xbe, 0x14, 0x31, 0x55,
...
TEST(SPDYCodecTest, SendRstParsingFrame) {
  ...
  SPDYCodec egressCodec(TransportDirection::UPSTREAM, SPDYVersion::SPDY3_1);
  SPDYCodec ingressCodec(TransportDirection::DOWNSTREAM, SPDYVersion::SPDY3_1);
  ...
  EXPECT_CALL(callbacks, onHeadersComplete(3, _))
      .WillOnce(InvokeWithoutArgs([&] {
        ingressCodec.generateRstStream(ingressCodecQueue, 1, ErrorCode::CANCEL);
      }));
...
uint8_t invalidNumNameValuesBlock[] = {
    ...
    0x05, 0x3a, 0x68, 0x6f, 0x73, 0x74, 0x00, 0x00, 0x00, 0x0b, 0x77, 0x77,
    0x77, 0x2e, 0x66, 0x6f, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x00, 0x00, 0x00,
    0x77, 0x3a, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x05, 0x3a, 0x70, 0x61, 0x74, 0x68, 0x00, 0x13, 0x00,
    0x14, 0x68, 0x74, 0x74, 0x39, 0x73, 0x3a, 0x2f, 0x2f, 0x77, 0x77, 0x77,
    0x2e, 0x66, 0x6f, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x00, 0x00, 0x00,
    0x07, 0x3a, 0x73, 0x63, 0x68, 0x65, 0x6d, 0x65, 0x00, 0x00, 0x00, 0x04,
    0x68, 0x74, 0x74, 0x70, 0x00, 0x00, 0x00, 0x08, 0x3a, 0x76, 0x65, 0x72,
    0x73, 0x69, 0x6f, 0x6e, 0x00, 0x00, 0x00, 0x08, 0x48, 0x54, 0x54, 0x50,
...
TEST(SPDYCodecTest, ShortSettings) {
  ...
  auto attack =
      folly::IOBuf::copyBuffer(kShortSettings, sizeof(kShortSettings));
...
TEST(SPDYCodecTest, ColonHeaders) {
  ...
  auto testBuf = folly::IOBuf::copyBuffer(kColonHeaders, sizeof(kColonHeaders));
...
TEST(SPDYCodecTest, StreamIdOverflow) {
  SPDYCodec codec(TransportDirection::UPSTREAM, SPDYVersion::SPDY3_1);
...
const uint8_t kBufBadNVBlock[] = {
    0x80, 0x03, 0x00, 0x01, 0x00, 0x00, 0x00, 0x1c, 0x00, 0x00, 0x00, 0x01,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0xbb, 0xe3, 0xc6, 0xa7, 0xc2,
    0x02, 0xa6, 0x23, 0xc6, 0xff, 0x40, 0x00, 0x00, 0x00, 0x00, 0xff, 0xff};
...
class SPDYCodecTestF : public HTTPParallelCodecTest {
 ...
 public:
  SPDYCodecTestF() : HTTPParallelCodecTest(upstreamCodec_, downstreamCodec_) {
  }
