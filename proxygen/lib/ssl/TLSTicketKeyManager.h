 ...
 *
 * A key is valid for decryption for the lifetime of the proxygen instance.
...
class TLSTicketKeyManager : private boost::noncopyable {
 ...
 private:
   ...
   * However, session_timeout seconds after deploying proxygen with a seed
   ...
   */
  friend int decrypt_fb_ticket(proxygen::TLSTicketKeyManager* manager,
